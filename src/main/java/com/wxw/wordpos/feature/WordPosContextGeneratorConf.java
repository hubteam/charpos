package com.wxw.wordpos.feature;
...
import com.wxw.wordpos.loader.ReadAdditionalDitionary;
...
public class WordPosContextGeneratorConf implements WordPosContextGenerator{
	...
	public WordPosContextGeneratorConf() throws IOException{
        ...
        InputStream featureStream = WordPosContextGeneratorConf.class.getClassLoader().getResourceAsStream("com/wxw/wordseg/run/feature.properties");
