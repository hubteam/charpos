...
public class WordPosModel extends BaseModel{
	...
	public SequenceClassificationModel<String> getWordSegPosSequenceModel() {
        ...
        if (artifactMap.get(WORDSEGPOS_MODEL_ENTRY_NAME) instanceof MaxentModel) {
            ...
            return new BeamSearch<String>(beamSize, (MaxentModel) artifactMap.get(WORDSEGPOS_MODEL_ENTRY_NAME));
        } else if (artifactMap.get(WORDSEGPOS_MODEL_ENTRY_NAME) instanceof SequenceClassificationModel) {
