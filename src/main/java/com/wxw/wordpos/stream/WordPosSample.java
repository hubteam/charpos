...
public class WordPosSample {
	 ...
	 */
	public WordPosSample(String[] characters,String[] words,String[] tagsAndposes,String[][] additionalContext){
	 ...
	 * @param additionalContext
	 */
    public WordPosSample(List<String> characters,List<String> words,List<String> tagsAndposes,String[][] additionalContext){
